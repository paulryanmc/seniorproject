		...
		while (marblesWindow.pollEvent(Event))
		{
			switch (Event.type){
				...
				case Event::MouseButtonPressed:
				{
					...
					if (p2Rec1.getGlobalBounds().contains(mousePosF) && p2Marbles[0] > 0 && turn == 2 && victory3 == false) {
						turn = 1;
						turnText.setString("Player 1 Turn");
						jax = 0;
						if (p2Marbles[0] == 10) {
					...
					if (p2Rec2.getGlobalBounds().contains(mousePosF) && p2Marbles[1] > 0 && turn == 2 && victory3 == false) {
						turn = 1;
						turnText.setString("Player 1 Turn");
						jax = 12;
						if (p2Marbles[1] == 11) {
					...
					if (p2Rec3.getGlobalBounds().contains(mousePosF) && p2Marbles[2] > 0 && turn == 2 && victory3 == false) {
						turn = 1;
						turnText.setString("Player 1 Turn");
						jax = 11;
						if (p2Marbles[2] == 12) {
					...
					if (p2Rec4.getGlobalBounds().contains(mousePosF) && p2Marbles[3] > 0 && turn == 2 && victory3 == false) {
						turn = 1;
						turnText.setString("Player 1 Turn");
						jax = 7;
						if (p2Marbles[3] == 3) {
					...
					if (p2Rec5.getGlobalBounds().contains(mousePosF) && p2Marbles[4] > 0 && turn == 2 && victory3 == false) {
						turn = 1;
						turnText.setString("Player 1 Turn");
						jax = 8;
						if (p2Marbles[4] == 2) {
					...
					if (p2Rec6.getGlobalBounds().contains(mousePosF) && p2Marbles[5] > 0 && turn == 2 && victory3 == false) {
						turn = 1;
						turnText.setString("Player 1 Turn");
						jax = 9;
						if (p2Marbles[5] == 1) {
